...
<head>
	...
	<?php
		...
		print "<p>You have completed $course Quiz #$quiz, $student.<br/>You got <strong>$correct<strong> out of <strong>".count($AnswerKey)." (<strong>$percent%</strong>) correct. Your score has been recorded.</p>";
